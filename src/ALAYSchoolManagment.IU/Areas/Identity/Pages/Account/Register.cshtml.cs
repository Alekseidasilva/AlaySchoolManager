...
namespace ALAYSchoolManagment.Presentation.IU.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "O campo {1}, é de selecção obrigatória")]
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "O campo {0}, é de preenchimeto obrigatório!")]
            [EmailAddress]
            [Display(Name = "Email")]
            ...
            [StringLength(100, ErrorMessage = "O campo {0} deve ter pelo menos {2} e no máximo {1} characteres.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "A Confirmação da Senha e a Senha não são iguais.")]
            public string ConfirmPassword { get; set; }

            [Required(ErrorMessage = "O campo {1}, é de selecção obrigatória")]
            public Int16 ModuloId { get; set; }
            [NotMapped]
            [ValidateNever]
            public SelectList ModuList { get; set; }
        }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            var func = _funcionariosApp.ObterTodos();
            Input = new InputModel
            {
                funcionarioList = new SelectList(func),
                //ModuList = _moduloAppService.ObterLista(),
            };
